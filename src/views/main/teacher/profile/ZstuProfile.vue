          ...
          <el-col :span="12">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
              <el-form-item label="工号">
                <el-input v-model="form.tno" :disabled="true"></el-input>
              </el-form-item>
...
import { setProfile } from 'network/teacher/setProfile'
...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess(res) {
      ...
      addAvatar(this.form.tno, data).then(res => {
